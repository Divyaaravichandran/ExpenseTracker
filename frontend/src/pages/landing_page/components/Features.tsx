...
const features = [
  {
    ...
    description:
      "Upload receipts and bills. Our AI extracts amounts, dates, and vendors automatically.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Expenses are auto-categorized so you can track spending by category with zero effort.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Dashboards and charts update in real time so you always see the latest picture.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    title: "Cloud Sync",
    description:
      "Access your expenses from any device. Everything syncs securely to the cloud.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Search and filter past expenses. Export reports for taxes or budgeting.",
  },
];
